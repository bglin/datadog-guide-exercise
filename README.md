![alt text](https://github.com/bglin/hiring-engineers/blob/solutions-engineer/images/logousage_white.png "Title")
...
![alt text](https://github.com/bglin/hiring-engineers/blob/solutions-engineer/images/overview.png "Title")
...
5. Take note of your Datadog API and APP key (Integrations > APIs in the console)
    ...
    ![alt text](https://github.com/bglin/hiring-engineers/blob/solutions-engineer/images/apikey.png "title")
...
![alt text](https://github.com/bglin/hiring-engineers/blob/solutions-engineer/images/tagsnew.png "title")

#### You can see that a postgres database container is running within the host

![alt text](https://github.com/bglin/hiring-engineers/blob/solutions-engineer/images/postgresnew.png "title")
...
- Complete the Postgres integration by
    ...
    ![alt text](https://github.com/bglin/hiring-engineers/blob/solutions-engineer/images/postgres1.png "text")

    - search ```postgres```

    - Scroll down and click

    ![alt text](https://github.com/bglin/hiring-engineers/blob/solutions-engineer/images/postgres2.png "text")
...
![alt text](https://github.com/bglin/hiring-engineers/blob/solutions-engineer/images/postgres4.png "text")
...
![alt text](https://github.com/bglin/hiring-engineers/blob/solutions-engineer/images/timeboard.png "text")
   ...
   - the Example Timeboard consists of three visualizations
     ...
     ![alt text](https://github.com/bglin/hiring-engineers/blob/solutions-engineer/images/newemail.png "text")
...
![alt text](https://github.com/bglin/hiring-engineers/blob/solutions-engineer/images/monitor1.png "text")

- the monitor can be configured  to send the message to an email

![alt text](https://github.com/bglin/hiring-engineers/blob/solutions-engineer/images/monitor2.png "text")
![alt text](https://github.com/bglin/hiring-engineers/blob/solutions-engineer/images/alert.png "text")
...
- To schedule downtime hover over **Monitors** in the main menu and click **Manage Downtime** in the sub-menu.
    ...
    ![alt text](https://github.com/bglin/hiring-engineers/blob/solutions-engineer/images/downtime1.png "text")

    - scheduled downtime on weekends


    ![alt text](https://github.com/bglin/hiring-engineers/blob/solutions-engineer/images/downtime2.png "text")

    - email notification for weekend downtime:

    ![alt text](https://github.com/bglin/hiring-engineers/blob/solutions-engineer/images/email1.png "text")

    - email notification for weekday downtime

    ![alt text](https://github.com/bglin/hiring-engineers/blob/solutions-engineer/images/email2.png "text")
...
![alt text](https://github.com/bglin/hiring-engineers/blob/solutions-engineer/images/apm.png "Title")
